...
\newcommand{\mscThesisTitle}{Estudo Empírico de Análise da Compatibilidade de Aplicações Android com as Diferentes Versões da API da Plataforma}
\newcommand{\mscThesisEnglishTitle}{Empirical Study on Android Application Compatibility with Different Versions of the Platform API}
...
\renewcommand{\date}{Janeiro de 2017}
