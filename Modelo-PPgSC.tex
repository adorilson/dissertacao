...
\newcommand{\mscThesisTitle}{Visualização da Evolução do Atributo de Qualidade de Desempenho em Sistemas de Software}
\newcommand{\mscThesisEnglishTitle}{Visualizing of Performance Quality Attribute Evolution in Software Systems}
\newcommand{\advisor}{Prof. Dr. Uirá Kulesza}
\newcommand{\coadvisor}{Prof. Dr. Felipe Pinto}
\newcommand{\city}{Natal-RN}
\renewcommand{\date}{Dezembro de 2016}
