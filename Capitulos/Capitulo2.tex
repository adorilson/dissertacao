...
\texttt{android.support.vX.TAXO- NOMIA.PACOTE}, % TODO gambiarra do espaço para 
                                                % quebra de linha
...
app       & \begin{tabular}[c]{@{}l@{}}
                Classes de alto nível que encapsulam todo o modelo de aplicações 
                                                            \\ Android \end{tabular}    & 1  \\ \hline
...
database  & \begin{tabular}[c]{@{}l@{}}Manipulação de dados retornados através de
                                      um provedor de \\ conteúdo \end{tabular}          & 1  \\ \hline
graphics  & \begin{tabular}[c]{@{}l@{}}Ferramentas gráficas de baixo nível, como
                canvas, filtros de cor, \\ pontos e retângulos que permitem desenhar
                                                        a tela diretamente\end{tabular} & 1 \\ \hline
...
nfc       & Funcionalidades para acesso a NFC (Near Field Communication)                & 9 \\ \hline
opengl    & Utilitários e interface para OpenGL ES                                      & 1 \\ \hline 
os        & \begin{tabular}[c]{@{}l@{}}Serviços básicos do sistema operacional,
                passagem de mensagens, \\ e comunicação inter-processo no
                                                               dispositivo\end{tabular} & 1 \\ \hline                                                             
...
telephony  & \begin{tabular}[c]{@{}l@{}}
                Monitoramento de informações básica do telefone, como tipo de 
                \\ rede e estado da conexão, além de utilitários para manipulação 
                \\ do número do telefone   \end{tabular}                                & 1 \\ \hline
text       & Renderização e manipulação de textos na tela                               & 1 \\ \hline
transition & \begin{tabular}[c]{@{}l@{}}
                Permite funcionalidade de "cenas e transições" para hierarquias 
                    \\ de view \end{tabular}                                           & 19 \\ \hline
util       & \begin{tabular}[c]{@{}l@{}}
                Utilidades diversas, como manipulação de data/hora, codificadores
                \\ e decodificadores de base64, conversão de string e números,
                \\ e utilitários para XML \end{tabular}                                & 1 \\ \hline
...
widget     & \begin{tabular}[c]{@{}l@{}}
                Elementos de interface com usuário (maioria visuais) para tela
                \\ da aplicação           \end{tabular}                                & 1 \\ \hline
java.io    & \begin{tabular}[c]{@{}l@{}} 
                Funcionalidades de entrada e saída de fluxo de dados, serialização
                \\ e sistemas de arquivos \end{tabular}                                & 1 \\ \hline
