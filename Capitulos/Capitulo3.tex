...
\begin{table}[!htbp] % TODO posicionar melhor essa tabela
  \centering
  \caption{10 elementos da taxonomia view com mais ocorrências de NewApi}
  \begin{tabular}{| l | r | r |}
  	\hline
  	% rótulo das colunas
  	\multicolumn{1}{|c|}{\textbf{Descrição}} &
...
dos casos, basta alterar a importação das classes, como mostramos  na Seção \ref{subsec:pacote-compatibilidade}. No entanto, pode resultar em um aumento no tamanho
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ | l | l |}
    ...
    Variabilidade na estrutura 		& Não oferece suporte \\ \hline
    Variabilidade no comportamento 	& Oferece suportada (Strategy, Null Object, Proxy) \\ \hline
    ...
    Legibilidade 					&  \begin{tabular}[c]{@{}l@{}}
    										Baixo impacto (Strategy), Médio impacto (Proxy),\\
    										Alto impacto (Null Object)
    									\end{tabular}								 \\ \hline
    Desempenho 						& \begin{tabular}[c]{@{}l@{}}
        										Baixo impacto (Decorator, Strategy, Null Object),\\
        										Médio Impacto (Proxy)
        									\end{tabular}								 \\ \hline
