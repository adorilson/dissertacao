...
As aplicações utilizadas no estudo são aplicações \textit{open-source} populares,
...
\begin{table}[!htb] % TODO posicionar melhor essa tabela
  ...
  \begin{tabular}{| l | l | r | r | r | r |}
	...
	\end{tabular} 	   & Ferramentas		& 10.000.000  &  4 & 22 &  18 \\ \hline
 	VLC for Android    &\begin{tabular}[l]{@{}l@{}} 
 	 						Reproduzir e \\ editar vídeos 
 	 					\end{tabular}    	& 50.000.000  &  8 & 23 &  65 \\ \hline
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{| l | l | r | r | r | r |}
 	...
 	\end{tabular}   & Personalização    	& 1.000.000 	  & 11 & 16 &   8 \\ \hline
 	...
 	\begin{tabular}[l]{@{}l@{}}
 		Yaac - \\ IRC Client
 	\end{tabular} 	& Comunicação 			& 50.000 	  & 16 & 16 &  12  \\ \hline
 	\end{tabular}
  \label{tab:grupo2}
\end{table}
...
aquelas cuja versão da API seja igual ou superior a 15 e a API mínima inicial
...
\begin{enumerate}
	\item Pesquisa textual por \texttt{VERSION.SDK\_INT} em todos os arquivos da
		aplicação;
	\item Quando \texttt{VERSION.SDK\_INT} fazia parte de um execução condicional,
	ou equivalente, relacionada a uma versão da API inferior à API mínima da aplicação,
	o código da aplicação era refatorado de forma a remover todo o código-morto.
	\item Contabilização e sumarização das linhas de código e arquivos removidos.
\end{enumerate}

O apêndice \ref{sec:apendice} apresenta informações adicionais sobre as aplicações analisadas e 
como acessar dados brutos obtidos durante o estudo.
...
oferecer suporte a dispositivos com versões mais antigas da API, foram
...
A figura \ref{fig:forma_suporte} apresenta a quantidade total de aplicações que
utilizam cada estratégia. Pacote de compatibilidade foi utilizada por 23 aplicações,
...
de 1556 ocorrências de NewApi. Desse total, 40,6\% foram tratados com EC indireta,
...
que nunca serão executados e, por fim, em duas pequenas frações de 0,3\% das ocorrências
foram utilizados tratamento de exceção ou são falsos positivos. Essas ocorrências de NewApi 
estão distribuídas em 22 aplicações (3 aplicações não apresentaram ocorrências de NewApi).
...
\begin{table}[!htbp] % TODO posicionar melhor essa tabela
  ...
  \begin{tabular}{| l | r | r | r | r |}
 	...
 	\end{tabular} &
 	\begin{tabular}[c]{@{}c@{}}\textbf{Importações}\\ \textbf{únicas}\end{tabular} &
 	\begin{tabular}[c]{@{}c@{}}\textbf{Média por}\\ \textbf{app (A/B)}\end{tabular} \\ \hline
 	%dados
 	animation 		& 1 			& 5   			&   4 			& 5,00  \\ \hline
 	\textbf{app}	& \textbf{22} 	& \textbf{849}  &  49 			& \textbf{38,59}\\ \hline
 	content 		& 17 			& 236 			&  11 			& 13,88  \\ \hline
 	graphics  		& 4 			& 9 			&   5 			& 2,25  \\ \hline
 	hardware   		& 1 			& 2 			&   1 			& 2,00  \\ \hline
 	media    		& 3 			& 15 			&   7 			& 5,00  \\ \hline
 	net     		& 1 			& 3   			&   1 			& 3,00  \\ \hline
 	os      		& 3 			& 6   			&   4 			& 2,00  \\ \hline
 	preference  	& 5 			& 99   			&  17 			& 19,80  \\ \hline
 	provider    	& 1 			& 12 			&   1			& 12,00   \\ \hline
 	text        	& 1 			& 1 			&   1 			& 1,00   \\ \hline
 	util       	 	& 9 			& 46 			&   9 			& 5,11   \\ \hline
 	view        	& 18 			& 233 			&  37 			& 12,94   \\ \hline
 	\textbf{widget} & 18			& 410 			&  \textbf{65} 	& 22,78   \\ \hline
  \end{tabular}
...
\begin{table}[!htbp] % TODO posicionar melhor essa tabela
  ...
  \begin{tabular}{| l | r | r | r | }
  	...
  	\begin{tabular}[c]{@{}c@{}}
  	 		\textbf{Total de}\\ \textbf{importações (A)}
  	 	\end{tabular} &
  	\multicolumn{1}{c|}{\textbf{Aplicações (B)}} &
 	\begin{tabular}[c]{@{}c@{}}\textbf{Média por}\\ \textbf{app (A/B)}\end{tabular} \\ \hline
 	%dados
 	v4.app.Fragment 			& 144			& 15	 			   		&   9,60 		\\ \hline
 	v4.app.NotificationCompat	& 80			& 16 			 			&   5,00 		\\ \hline
 	v4.app.DialogFragment  		& 76			& 12 			   			&   6,33 		 \\ \hline
 	v7.app.AlertDialog     		& 72			& 11 			   			&   6,55		  \\ \hline
 	v7.app.AppCompatActivity  	& 67			& 14 			   			&   4,79 		  \\ \hline
 	v4.app.FragmentManager    	& 65			& 16 			 			&   4,06		   \\ \hline
 	v4.app.FragmentActivity    	& 58			& 12 			 			&   4,83 		\\ \hline
 	v4.app.LoaderManager       	& 50			& 7 			 			&   7,14 		\\ \hline
 	v7.app.ActionBar        	& 37			& 13 			 			&   2,85 		\\ \hline
 	v4.app.ActivityCompat 		& 25			& 14			 			&   1,79 	   \\ \hline
  \end{tabular}
...
mais comuns são \texttt{RecyclerView} e \texttt{Toolbar}. A primeira possui o
...
\begin{table}[!htbp] % TODO posicionar melhor essa tabela
  ...
  \begin{tabular}{| l | r | r | r | }
 	...
 	\end{tabular} &
 	\begin{tabular}[c]{@{}c@{}}
 	  	 		\textbf{Aplicações}\\ \textbf{(B)}
 	  	\end{tabular} &
 	\begin{tabular}[c]{@{}c@{}}\textbf{Média por}\\ \textbf{app (A/B)}\end{tabular} \\ \hline
 	%dados
 	v7.widget.RecyclerView 				& 81	& 9 	 	  		&   9,00 	\\ \hline
 	v7.widget.Toolbar					& 52	& 12 	 			&   4,33 	\\ \hline
 	v7.widget.LinearLayoutManager		& 26	& 9 	   			&   2,89 	\\ \hline
 	design.widget.Snackbar     			& 23	& 6 	   			&   3,83	\\ \hline
 	v7.widget.SearchView  				& 21	& 8		   			&   2,63 	\\ \hline
 	v4.widget.DrawerLayout    			& 15	& 9 	 			&   1,67	\\ \hline
 	design.widget.FloatingActionButton  & 13	& 4		 			&   3,25 	\\ \hline
 	v7.widget.PopupMenu       			& 12	& 5 	 			&   2,40 	\\ \hline
 	design.widget.TabLayout        		& 10	& 6		 			&   1,67 	\\ \hline
 	v4.widget.SwipeRefreshLayout 		& 10	& 5		 			&   2,00 	\\ \hline
  \end{tabular}
...
Pacote de compatibilidade e re-implementação de recursos são utilizados para uso de
...
escolha individual de cada desenvolvedor. O padrão de projeto \textit{Proxy} foi
...
Em termos quantitativos, 5 aplicações (50\%) apresentaram menos de 10 novas ocorrências 
de NewApi ao reduzir a versão mínima da API. No geral, surgem, em média, 15,60 novas
ocorrências, considerando a redução para a API imediatamente inferior à atual. O caso mais
...
coesão do código, favoreçam tal cenário, fazendo com que o desenvolvedor tenha uma melhor
